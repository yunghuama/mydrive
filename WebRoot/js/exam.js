...
Exam.prototype = {
	...
	drawQuestion : function(question){
		...
		if(question.video!=""&&question.video!=null){
			var video = '<embed src="'+projectName+'/js/ckplayer/ckplayer.swf" flashvars="f='+projectImage+'/'+question.path+'/'+question.video.toLowerCase()+'&p=0" quality="high" width="700" height="300" align="middle" allowScriptAccess="always" allowFullscreen="true" type="application/x-shockwave-flash"></embed>';
