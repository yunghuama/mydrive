...
<body style="overflow:auto">
	 <div id="main">
			<div id="title"><span>用户登录次数统计</span></div>
			<div id="sectionContent">
				<div id="search"><span>起始日期:</span><s:textfield  id="sDate1" name="stDate" theme="simple" cssClass="text" onClick="WdatePicker()"></s:textfield>&nbsp;&nbsp;&nbsp;<span>结束日期:</span><s:textfield  id="eDate1" theme="simple" name="enDate" cssClass="text" onClick="WdatePicker()"></s:textfield><button id="searchButton">查询</button></div>
				<table>
					<tr>
						<th width="10%">序号</th>
						<th>日期</th>
			...
			<div id="pageBar">
			<form action="<%=path %>/exam/system/listLoginLogs.d" method="post">
