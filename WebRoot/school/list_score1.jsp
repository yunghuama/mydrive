...
<body style="overflow:auto">
	 <div id="main">
			...
			<div id="sectionContent">
				<div id="search"><span>姓名:</span><s:textfield name="name" id="nameVal" theme="simple" cssClass="text"></s:textfield><button id="searchButton">查询</button><a href='<%=path %>/exam/system/exportStaticSocre1.d' id="exportAll">导出所有成绩</a></div>
				<table>
					<tr>
						<th width="10%">序号</th>
						<th>学员名称</th>
