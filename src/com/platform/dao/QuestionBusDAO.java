...
public class QuestionBusDAO extends GenericDAO{
	...
	public int saveQuestion_Bus(Question question,String code){
        String sql = formatSQL(SQLConstant.QUESTION_BUS_SAVE,"questions_bus",code);
	...
	public List<QuestionVO> listQuestionRandom_bus(){
        ...
        String sql = formatSQL(SQLConstant.QUESTION_BUS_QUERY_RANDOM,"questions_bus",type);
	...
	public Page<QuestionVO> listQuestionOrder_bus(Page<QuestionVO> page,String category) throws Exception{
        ...
        Users users  = LoginBean.getLoginBean().getUser();
        String type = users.getQuestionType();
        String sql = formatSQL(SQLConstant.QUESTION_BUS_QUERY_PAGE,"questions_bus",type);
	...
	public Question findQuestionById(int id,String type){
        String sql = formatSQL(SQLConstant.QUESTION_BUS_QUERY_BY_ID,"questions_bus",type);
	...
	public int updateQuestion(Question question,String type){
        ...
        String sql = formatSQL(SQLConstant.QUESTION_BUS_UPDATE_BY_ID,"questions_bus",type);
		return jdbcTemplate.update(sql, new Object[]{
				question.getCode(),
				question.getQuestion(),
				question.getAnswer_a(),
	 ...
	 * 查询已标记题目
	 */
	public Page<QuestionVO> listMarkQuestionBus(Page page,String studentId,int type) throws Exception{

        Users users  = LoginBean.getLoginBean().getUser();
        String questionType = users.getQuestionType();
        String sql = formatSQL(SQLConstant.MARK_QUESTION_BUS_QUERY_PAGE,"questions_bus",questionType);
	 ...
	 * 查询错题
	 */
	public Page<QuestionVO> listWrongQuestionBus(Page page,String studentId,int type) throws Exception{

        Users users  = LoginBean.getLoginBean().getUser();
        String questionType = users.getQuestionType();
        String sql = formatSQL(SQLConstant.WRONG_QUESTION_BUS_QUERY_PAGE,"questions_bus",questionType);
