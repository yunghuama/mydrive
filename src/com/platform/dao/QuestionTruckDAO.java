...
public class QuestionTruckDAO extends GenericDAO{
	...
	public Page<QuestionVO> listQuestionOrder_truck(Page<QuestionVO> page,String category){
		List<QuestionVO> list =  jdbcTemplate.query(SQLConstant.QUESTION_TRUCK_QUERY_PAGE,new Object[]{category,(page.getCurrPage()-1)*page.getPageSize(),page.getPageSize()},new RowMapper<QuestionVO>(){
			@Override
			public QuestionVO mapRow(ResultSet rs, int arg1)
					throws SQLException {
				QuestionVO vo = new QuestionVO();
		...
		int rowCount = queryForInt(SQLConstant.QUESTION_TRUCK_QUERY_ROWCOUNT,category);
	 ...
	 * @return
	 */
	public Page<QuestionVO> listQuestionOrderAll_truck(Page<QuestionVO> page){
		List<QuestionVO> list =  jdbcTemplate.query(SQLConstant.QUESTION_TRUCK_QUERY_PAGE_ALL,new Object[]{(page.getCurrPage()-1)*page.getPageSize(),page.getPageSize()},new RowMapper<QuestionVO>(){
			@Override
			public QuestionVO mapRow(ResultSet rs, int arg1)
					throws SQLException {
				QuestionVO vo = new QuestionVO();
		...
		int rowCount = queryForInt(SQLConstant.QUESTION_TRUCK_QUERY_ROWCOUNT_ALL);
		page.setRowCount(rowCount);
		page.setMaxPage(PageHelper.getMaxPage(rowCount, page.getPageSize()));
		page.setList(list);
		return page;
	 ...
	 * 查询已标记题目
	 */
	public Page<QuestionVO> listMarkQuestionTruck(Page page,String studentId,int type){
		List<QuestionVO> list = jdbcTemplate.query(SQLConstant.MARK_QUESTION_TRUCK_QUERY_PAGE, new Object[]{studentId,type,(page.getCurrPage()-1)*page.getPageSize(),page.getPageSize()}, new RowMapper<QuestionVO>(){
			@Override
	 ...
	 * 查询错题
	 */
	public Page<QuestionVO> listWrongQuestionTruck(Page page,String studentId,int type){
		List<QuestionVO> list = jdbcTemplate.query(SQLConstant.WRONG_QUESTION_TRUCK_QUERY_PAGE, new Object[]{studentId,type,(page.getCurrPage()-1)*page.getPageSize(),page.getPageSize()}, new RowMapper<QuestionVO>(){
			@Override
			public QuestionVO mapRow(ResultSet rs, int arg1) throws SQLException {
				QuestionVO vo = new QuestionVO();
				vo.setId(rs.getInt("id"));
